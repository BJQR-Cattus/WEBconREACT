...
function AgenciaChurcampa() {
    ...
    const descripcionEncargado =
        "Nuestro objetivo es buscar en todo momento la participación con la asistencia técnica y orientaciones para mejorar la calidad de vida de los productores agropecuarios, en cumplimiento del marco estratégico de la misión y visión.";
    ...
    return (
        <>
            <main>
                ...
                <section className="degradado-section">
                    ...
                    <div className="texto-container">
                        <h1>AGENCIA AGRARIA CHURCAMPA</h1>
                        <h2>NOSOTROS</h2>
                        <p>
                            La Agencia Agraria dependiente de la Dirección Regional
                            Agraria, del Distrito y Provincia de Churcampa, Región
                            Huancavelica, es una institución del sector agrario y como
                            tal su finalidad es velar por el desarrollo de los
                            productores agropecuarios organizados, acompañándolos en el
                            proceso productivo, encaminando tecnologías de acuerdo a la
                            potencialidad de cada zona, promover el desarrollo e
                            impulsar la competitividad de la actividad agropecuaria,
                            cumplir y hacer cumplir las normas sobre los recursos
                            naturales y la actividad agraria, en coordinación con las
                            dependencias de los proyectos y organismos públicos, e
                            integrar el sistema nacional de información agraria en la
                            obtención y difusión de información para la gestión de los
            ...
            <div id="directora-info">
                ...
                <p><span className="director-name">ING. JESUS A. MERINO LIZANA</span></p>
                <p><span className="director-cargo">DIRECTOR DE LA AGENCIA AGRARIA CHURCAMPA</span></p>
...
export default AgenciaChurcampa;